...
public class SybaseASEPlugin extends DefaultSessionPlugin {
    ...
    private final static ILogger s_log = LoggerController.createLogger(SybaseASEPlugin.class);
    ...
    public IGlobalPreferencesPanel[] getGlobalPreferencePanels() {
        ...
        PluginQueryTokenizerPreferencesPanel _prefsPanel =
                new PluginQueryTokenizerPreferencesPanel(_prefsManager, SCRIPT_SETTINGS_BORDER_LABEL_DBNAME, includeProcSepPref);
    ...
    public PluginSessionCallback sessionStarted(ISession session) {
        ...
        otApi.addDetailTab(DatabaseObjectType.VIEW, new ViewSourceTab(i18n.SHOW_VIEW_SOURCE, stmtSep));
        ...
        otApi.addDetailTab(DatabaseObjectType.TRIGGER, new TriggerSourceTab(i18n.TRIGGER_HINT, stmtSep));
