...
public class ScriptSybaseASEViewAction extends SquirrelAction {
     ...
     */
    transient private final ILogger s_log = LoggerController.createLogger(ScriptSybaseASEViewAction.class);
    ...
    public void actionPerformed(ActionEvent evt) {
        try {
            ...
            s_log.error(
                    "Unexpected exception while attempting to get source for view: " + e.getMessage(), e);
